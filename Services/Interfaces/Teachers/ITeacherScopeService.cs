...
{
    Task<bool> HasClassAccessAsync(int userId, int classId, int sectionId, CancellationToken ct = default);
    Task<bool> HasSubjectAccessAsync(int userId, int subjectId, int classId, int sectionId, CancellationToken ct = default);
