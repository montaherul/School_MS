...
{
    /// <inheritdoc />
    public partial class NormalizeERPSystemRoles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Aggressive Cleanup: Disable constraints, wipe Role-related data 8+, and prepare for fresh normalized seeding
            migrationBuilder.Sql(@"
                -- 1. Create temporary mapping based on names for UserRole preservation
                CREATE TABLE #NewRoleMap (OldName NVARCHAR(256), NewId INT);
                INSERT INTO #NewRoleMap (OldName, NewId) VALUES 
                ('Super Admin', 1), ('SuperAdmin', 1),
                ('Admin', 2),
                ('Principal', 3),
                ('Assistant Head', 2),
                ('HR Manager', 4), ('HRManager', 4),
                ('Accountant', 5),
                ('Senior Lecturer', 6), ('Lecturer', 6), ('Teacher', 6),
                ('Librarian', 7),
                ('Office Staff', 8), ('Staff', 8),
                ('Student', 9),
                ('Parent', 10);

                -- 2. Clear all existing RolePermissions (will be re-inserted by migration)
                DELETE FROM RolePermissions;

                -- 3. Preserve and re-map UserRoles into a temp table
                SELECT DISTINCT ur.UserId, m.NewId AS RoleId
                INTO #PreservedUserRoles
                FROM UserRoles ur
                JOIN Roles r ON ur.RoleId = r.Id
                JOIN #NewRoleMap m ON (r.Name = m.OldName);
                ...
                -- 5. Restore preserved UserRoles for IDs 1-7 (8-10 will be handled by a separate script or later)
                -- Actually, we can't restore 8-10 yet because the Roles don't exist in the DB until the migration finishes.
                -- So we only restore 1-7 now.
                INSERT INTO UserRoles (UserId, RoleId)
                SELECT UserId, RoleId FROM #PreservedUserRoles WHERE RoleId <= 7;

                DROP TABLE #NewRoleMap;
                -- Note: UserRoles 8-10 will need to be re-assigned or handled in a post-migration seeder.
                -- For now, this stabilizes the schema normalization.
            ");
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "Id",
                keyValue: 1,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Full system owner with all permissions", true, "SuperAdmin", 100 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Administrative operations", true, "Admin", 95 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Academic + operational authority", true, "Principal", 90 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Human resource management", true, "HRManager", 80 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Financial operations", true, "Accountant", 70 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Academic teaching operations", true, "Teacher", 60 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Library management", true, "Librarian", 50 });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Description", "IsActive", "IsDeleted", "IsSystemRole", "Name", "Priority", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { 8, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "system", "General employee operations", true, false, true, "Staff", 40, null, null },
                    { 9, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "system", "Student portal access", true, false, true, "Student", 10, null, null },
                    { 10, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "system", "Parent portal access", true, false, true, "Parent", 5, null, null }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 226, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 227, 6 });
            ...
            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 229, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 230, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 231, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 232, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 233, 6 });
            ...
            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 235, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 236, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 237, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 238, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 239, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 240, 6 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 241, 6 });
            ...
            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 141, 8 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 142, 8 });
            ...
            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 172, 10 });

            migrationBuilder.DeleteData(
                table: "RolePermissions",
                keyColumns: new[] { "PermissionId", "RoleId" },
                keyValues: new object[] { 217, 10 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "System owner with all permissions", false, "Super Admin", 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Final approval and all modules", false, "Principal", 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Academic operations", false, "Assistant Head", 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Teaching and review", false, "Senior Lecturer", 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Teaching operations", false, "Lecturer", 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Admission, fees, reports", false, "Office Staff", 0 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Description", "IsSystemRole", "Name", "Priority" },
                values: new object[] { "Student portal access", false, "Student", 0 });
        }
    }
}
