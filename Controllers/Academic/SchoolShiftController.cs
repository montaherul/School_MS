...
[Authorize]
public class SchoolShiftController : Controller
{
    private readonly ISchoolShiftService _service;

    public SchoolShiftController(ISchoolShiftService service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> CreateEdit(int? id)
    {
        if (id.HasValue && id > 0)
        {
            ...
            var vm = new SchoolShiftViewModel
            {
                Id = dto.Id,
                Name = dto.Name,
                Code = dto.Code,
        ...
        return View(new SchoolShiftViewModel { DisplayOrder = 0 });
    }

    [HttpPost]
    [ValidateAntiForgeryToken]
    [RequirePermission("Academic.Create")]
    public async Task<IActionResult> CreateEdit(SchoolShiftViewModel vm)
    {
        ...
        if (vm.IsEditMode)
        {
            ...
            TempData["SuccessMessage"] = "School Shift updated successfully.";
        }
        else
        {
            await _service.CreateAsync(vm, userId);
            TempData["SuccessMessage"] = "School Shift created successfully.";
        }
    ...
    [ValidateAntiForgeryToken]
    [RequirePermission("Academic.Create")]
    public Task<IActionResult> Save(SchoolShiftViewModel vm) => CreateEdit(vm);
    ...
    public async Task<IActionResult> DeleteConfirmed(int id, CancellationToken cancellationToken)
    {
        ...
        TempData["SuccessMessage"] = "School Shift deleted successfully.";
        return RedirectToAction(nameof(Index));
    }
}
