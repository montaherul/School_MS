...
public class SchoolClassController : Controller
{
    ...
    public async Task<IActionResult> CreateEdit(int? id)
    {
        if (id.HasValue && id > 0)
        {
            ...
            var vm = new SchoolClassViewModel { Id = dto.Id,Name = dto.Name,SortOrder = dto.SortOrder,            };
            return View(vm);
        }
    ...
    public async Task<IActionResult> CreateEdit(SchoolClassViewModel vm)
    {
        ...
        if (vm.IsEditMode) { await _service.UpdateAsync(vm, userId); TempData["SuccessMessage"] = "SchoolClass updated successfully."; }
        else { await _service.CreateAsync(vm, userId); TempData["SuccessMessage"] = "SchoolClass created successfully."; }
    ...
    public async Task<IActionResult> DeleteConfirmed(int id, CancellationToken cancellationToken)
    {
        ...
        TempData["SuccessMessage"] = "SchoolClass deleted successfully.";
        return RedirectToAction(nameof(Index));
    }
}
