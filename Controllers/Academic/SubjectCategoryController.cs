...
public class SubjectCategoryController : Controller
{
    ...
    public SubjectCategoryController(ISubjectCategoryService service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> CreateEdit(int? id)
    {
        ...
        return View(new SubjectCategoryViewModel { DisplayOrder = 0 });
    }

    [HttpPost]
    [ValidateAntiForgeryToken]
    [RequirePermission("Academic.Create")]
    public async Task<IActionResult> CreateEdit(SubjectCategoryViewModel vm)
    {
    ...
    [ValidateAntiForgeryToken]
    [RequirePermission("Academic.Create")]
    public Task<IActionResult> Save(SubjectCategoryViewModel vm) => CreateEdit(vm);
