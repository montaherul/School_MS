...
public class DashboardService : IDashboardService
{
    ...
    public async Task<StudentDashboardViewModel> GetStudentDashboardAsync(int userId, CancellationToken cancellationToken = default)
    {
        ...
        return new StudentDashboardViewModel
        {
            ...
            AttendancePercentage = data.totalAttendance == 0 ? 0 : (double)Math.Round((decimal)(data.presentCount + data.lateCount) / data.totalAttendance * 100, 2),
            ...
            RecentNotices = data.recentNotices.Select(n => new StudentNoticeDto { Id = 0, Title = n.Title, Date = n.At, Excerpt = n.Summary, Category = n.Module }).ToList(),
